...
if user_input:
    ...
    # Update Streamlit visible chat history
    st.session_state.chat_history.append({"role": "user", "content": user_input})
    st.session_state.chat_history.append({"role": "assistant", "content": response.response})

    # Update internal memory of the chat engine
    chat_engine.conversation_history.append({"user": user_input, "assistant": response.response})

    # ✅ Display the assistant response visibly in the UI
